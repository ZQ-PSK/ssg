...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.042902b3cdf971df78ffd77f7430b2090b76aeeadad9b781b32a4c643612330c.js',function(){input.required=false;search();});}
