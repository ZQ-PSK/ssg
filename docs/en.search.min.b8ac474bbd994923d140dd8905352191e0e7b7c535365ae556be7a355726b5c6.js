...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e2871bdf11cb823bd05995477e5272a08d8c7b3154a73d782561848937fcd194.js',function(){input.required=false;search();});}
