...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a34b08ba0a0b2ae1dc4c905cd70bef843c593e712ad2ef39dd9de12a88975cbe.js',function(){input.required=false;search();});}
