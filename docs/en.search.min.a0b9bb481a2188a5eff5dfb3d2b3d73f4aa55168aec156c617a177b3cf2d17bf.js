...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.393db227bf78f9d889b6d3c47b50a453926709706ea692695c27ee1748d159bb.js',function(){input.required=false;search();});}
