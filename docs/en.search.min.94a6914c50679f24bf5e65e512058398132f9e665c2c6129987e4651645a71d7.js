...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ae140f7ac876d6f077d5602355f6a6a2493e4f6cd33815eaad0afd8224597548.js',function(){input.required=false;search();});}
