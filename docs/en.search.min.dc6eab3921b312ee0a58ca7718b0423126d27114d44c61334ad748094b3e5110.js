...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6360130a167babb8570f1369dca832ff8d8d55cee5fa53ebc7056974bf39c0aa.js',function(){input.required=false;search();});}
