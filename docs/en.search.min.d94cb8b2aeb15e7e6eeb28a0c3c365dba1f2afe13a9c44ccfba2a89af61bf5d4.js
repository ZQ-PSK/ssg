...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ssg/flexsearch.min.js');loadScript('/ssg/en.search-data.min.5ef441d3affcf149323705a9f77fbb72d2c8f5d35e34a25df40e2d926a564a29.js',function(){input.required=false;search();});}
