...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/zq-psk.github.io/ssg/flexsearch.min.js');loadScript('/zq-psk.github.io/ssg/en.search-data.min.5bce5e9509de213ce1515b4e2216c3688e98ce1925cacb4f8be31357b61dcdc5.js',function(){input.required=false;search();});}
