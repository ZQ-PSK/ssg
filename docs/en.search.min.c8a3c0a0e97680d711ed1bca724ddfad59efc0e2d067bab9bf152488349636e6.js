...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.074685ee72be370d5076870b639405066017eed11c27afa0015358aa0804b545.js',function(){input.required=false;search();});}
